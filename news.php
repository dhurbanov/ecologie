	...
	<div id="wrapper">
		...
		<div id="block2a">
			<div class="fwidth">
				<div class="c_qs">
					<div class="news">
						<div class="cqs_header"><h3><a href="#" color="#1ebc56">Header</a></h3><span>17.12</span></div>
						<div class="clr"></div>
					...
					<div class="news">
						<div class="cqs_header"><h3><a href="#" class="">Header</a></h3><span>17.12</span></div>
						<div class="clr"></div>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
				...
				<div class="s_cont">
					<h5 class="h5n shad">Header</h5>
					<!--<div class="image"><img src="" width="640"></div>-->
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
					quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
